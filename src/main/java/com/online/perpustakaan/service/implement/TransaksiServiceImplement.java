...
//        mstTransaksi.setUserId(requestDTO.getUserId());
    ...
    public ResponseEntity<List<DtoTransaksiView>> getTransaksi(String noTiket, String status, String kodeBuku) {
        ...
        for (Object[] obj : resultList) {
            ...
            transaksiView.setKeterangan((String) obj[6]);
            transaksiView.setJumlah((Integer) obj[7]);
            transaksiView.setTglPinjam((Date) obj[8]);
            transaksiView.setTglPengembalian((Date) obj[9]);
